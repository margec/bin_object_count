        ...
        for type in ['train', 'val']:
            ...
            if type == 'val':
                if accuracy > best_accuracy:
                    ...
                    print(f'Accuracy has not improved from the previous epoch {epoch-1}, but we will keep going!')
                    has_improved = False
...
def main(args):
    ...
    print(f"Saved the best model params to 'model.pt'")
...
if __name__=='__main__':
    ...
    print('train.py was called with these parameters: ')
    print(args)
